    ...
    class ContadorComponent {
        ...
        prepararBotao($elementoBotao, iniciarFn) {
            ...
            return (valor = true) => {
                ...
                if (valor) {
                    $elementoBotao.setAttribute(atributo, true)
                    return
                }
        ...
        inicializar() {
            ...
            const atualizaTexto = this.atualizarTexto(argumentos);
            const idIntervalo = setInterval(atualizaTexto, PERIODO_INTERVALO)
