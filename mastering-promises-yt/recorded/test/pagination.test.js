...
describe('Pagination tests', () => {
    ...
    describe('#Pagination', () => {
        it('#sleep should be a Promise object and not return any values', async () => {
        ...
        describe('#getPaginated', () => {
            const responseMock = [{"tid":5705,"date":1373123005,"type":"sell","price":196.52,"amount":0.01},{"tid":5706,"date":1373124523,"type":"buy","price":200,"amount":0.3}]
            ...
            it('should update request id on each request', async () => {
                ...
                const secondCallExpectedData = {
                    ...data,
                    page: responseMock[0].tid
                }
                const thirdCallExpectedData = {
                    ...secondCallExpectedData,
                ...
                assert.deepStrictEqual(getFirstArgfromCall(1), secondCallExpectedData)
                assert.deepStrictEqual(getFirstArgfromCall(2), thirdCallExpectedData)
            })
